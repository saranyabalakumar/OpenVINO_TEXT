...
# - [Run](#Run-Uparrow)
#     - [Run on local paragraphs](#Run-on-local-paragraphs-Uparrow)
#     - [Run on websites](#Run-on-websites-Uparrow)
# 
...
try:
    subprocess.run(['python', '-m', 'pip', 'install', 'tqdm'], check=True)
except subprocess.CalledProcessError as e:
    print("Error installing the 'tqdm' package:", e)

# Use subprocess to run pip install command for ipywidgets
try:
...
# ## The model [$\Uparrow$](#Table-of-content:)
# 
...
# ## Processing [$\Uparrow$](#Table-of-content:)
# 
...
vocab_file_path = "../213-question-answering/vocab.txt"
...
# 
# ### Run on local paragraphs [$\Uparrow$](#Table-of-content:)
# 
...
# ### Run on websites [$\Uparrow$](#Table-of-content:)
# 
